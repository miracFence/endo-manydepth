...
class Trainer_Monodepth:
    ...
    def get_v(self,depth_data,pa,pb,K):
        pa_y,pa_x = pa
        pb_y,pb_x = pb
        pa = torch.tensor(pa).to(device=depth_data.device)
        pb = torch.tensor(pb).to(device=depth_data.device)
        
        #print(pa)
        #print(pb)
        #print(pa_y)
        #print(depth_data.shape)
        Da = depth_data[0,pa_y,pa_x] #Value depth shape(1)
        Db = depth_data[0,pb_y,pb_x] #Value depth shape(1)
