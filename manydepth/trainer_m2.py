        ...
        for j in range(min(4, self.opt.batch_size)):  # write a maxmimum of four images
            ...
            for frame_id in self.opt.frame_ids:
                ...
                if s == 0 and frame_id != 0:
                    ...
                    wandb.log({"contrast_{}_{}/{}".format(frame_id, s, j): wandb.Image(outputs["ch_"+str(frame_id)+"_"+str(s)][j].data)},step=self.step)
                    wandb.log({"brightness_{}_{}/{}".format(frame_id, s, j): wandb.Image(outputs["bh_"+str(frame_id)+"_"+str(s)][j].data)},step=self.step)
