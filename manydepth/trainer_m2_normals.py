...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss3(self, disp, N_hat, K_inv):
        ...
        top_left_depth = top_left_flat[:,:,:2].transpose(1, 2) * D
        bottom_right_depth = bottom_right_flat[:,:,:2].transpose(1, 2) * D
        top_right_depth = top_right_flat[:,:,:2].transpose(1, 2) * D
        bottom_left_depth = bottom_left_flat[:,:,:2].transpose(1, 2) * D
