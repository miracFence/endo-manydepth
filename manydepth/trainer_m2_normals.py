...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss4(self, disp, N_hat, K_inv):
        ...
        bottom = torch.stack([x,torch.clamp(y + 1.0, min=0, max=height-1)], dim=-1).to(device=K_inv.device)
    ...
    def compute_orth_loss3(self, disp, N_hat, K_inv):
        ...
        D_hat_pa = D[:,:,top_left_flat_[0,1,:].long(), top_left_flat_[0,0,:].long()]
        D_hat_pb = D[:,:,bottom_right_flat_[0,1,:].long(), bottom_right_flat_[0,0,:].long()]
        D_hat_pa2 = D[:,:,top_right_flat_[0,1,:].long(), top_right_flat_[0,0,:].long()]
        D_hat_pb2 = D[:,:,bottom_left_flat_[0,1,:].long(), bottom_left_flat_[0,0,:].long()]
