...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss3(self, disp, N_hat, K_inv):
        ...
        top_left_depth = top_left_flat_.permute(0, 2, 3, 1)
        top_left_depth[..., 0] /= width - 1
        top_left_depth[..., 1] /= height - 1
        top_left_depth = (top_left_depth_ - 0.5) * 2
        ...
        top_right_depth = top_right_flat_.permute(0, 2, 3, 1)
        ...
        bottom_left_depth = bottom_left_flat_.permute(0, 2, 3, 1)
        ...
        #D_hat_pb2 = torch.nn.functional.grid_sample(D, bottom_left_flat_.reshape(batch_size,height,width,2), mode='bilinear', align_corners=False)
        ...
        #print(top_left_flat_.shape)
        V = D.view(12,1,-1) * pa_tl - D.view(12,1,-1) * pb_br
        ...
        V = D.view(12,1,-1) * pa_tr - D.view(12,1,-1) * pb_bl
