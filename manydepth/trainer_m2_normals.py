...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss3(self, disp, N_hat, K_inv):
        ...
        #V = torch.matmul(top_left_depth.view(12,1,height,width) , pa_tl.view(12,3,height,width)) - torch.matmul(bottom_right_depth.view(12,1,height,width) , pb_br.view(12,3,height,width))
        ...
        #V = torch.matmul(bottom_right_depth.view(12,1,height,width) , pa_tr.view(12,3,height,width)) - torch.matmul(bottom_left_depth.view(12,1,height,width) , pb_bl.view(12,3,height,width))
