...
class Trainer_Monodepth2:
    ...
    def compute_orth_loss3(self, disp, N_hat, K_inv):
        ...
        wandb.log({"disp_multi_tl": wandb.Image(top_left_depth.view(0,1,height,width).transpose(1, 2, 0))},step=self.step)
        wandb.log({"disp_multi_o": wandb.Image(D.transpose(1, 2, 0))},step=self.step)
